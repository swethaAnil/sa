...
$orderChecklistSQL = "SELECT checklist FROM $v2ordertable WHERE order_num = $order_num";
...
if($orderChecklist[0] == NULL){
	$saveOrderChecklistSQL = "UPDATE $v2ordertable SET checklist = '$question_list' WHERE order_num = '$order_num'";
