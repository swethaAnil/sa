...
if($_GET['order_num']){
	...
	$order_output = "SELECT * FROM current_v2_orders WHERE order_num = '$_GET[order_num]' ORDER BY activation_date DESC LIMIT 1";
...
<title>2.0 Order Dashboard - Service Activations</title>
<!--[if IE]>
...
$(document).ready(function(){
	...
	$("#order_checklist").load("../checklist/viewChecklist.php?order_num=<?php echo $order_num; ?>&src=v2_order_dashboard");
...
$count = count($bits)-1;
if($bits[$count] == "current_v2_orders.php"){
...
<div id="dashboard_title">2.0 Order Dashboard</div>
<?php
