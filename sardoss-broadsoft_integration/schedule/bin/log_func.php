	...
	while ($row = mysql_fetch_array($out_result)){
		...
		if($date == $current_date){
			...
			if($_SERVER['PHP_AUTH_USER'] == $row['user']){
				...
				echo "<td id=\"rightlog\" align=\"left\"><a href=\"editNote.php?noteID=$id\" onClick=\"return editNotePopup(this, 'notes')\" style=\"margin-left:0px;\"><img  src=\"../images/edit.png\" width=\"15px\" height=\"15px\" align=\"center\" name=\"EDIT NOTE\" value=\"Edit Note\" /></a></td>";
			}else{
			...
			echo "<tr>";
			echo "<td id=\"leftlogALT\" valign=\"top\" align =\"right\">$timestamp</td><td id=\"leftlogALT\" valign=\"top\" align=\"center\">$user</td><td id=\"rightlogALT\" align=\"left\">$entry</td><td id=\"rightlogALT\" align=\"left\" style=\"width:20px;\">$time_spent</td>";
			if($_SERVER['PHP_AUTH_USER'] == $row['user']){
				echo "<td id=\"rightlogALT\" align=\"left\"><a href=\"editNote.php?noteID=$id\" onClick=\"return editNotePopup(this, 'notes')\" style=\"margin-left:0px;\"><img  src=\"../images/edit.png\" width=\"15px\" height=\"15px\" align=\"center\" name=\"EDIT NOTE\" value=\"Edit Note\" /></a></td>";
			}else{
				echo "<td id=\"rightlogALT\" align=\"left\"></td>";
			} 
...
function get_tech_info($id,$connection){
