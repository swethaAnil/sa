...
echo "<INPUT TYPE=\"BUTTON\" VALUE=\"Schedule Manager\" ONCLICK=\"window.location.href='schedule_manager.php'\">";
echo "<INPUT TYPE=\"BUTTON\" VALUE=\"Build Schedule\" ONCLICK=\"window.location.href='build_schedule.php'\"></FORM>";
echo "<br>";
