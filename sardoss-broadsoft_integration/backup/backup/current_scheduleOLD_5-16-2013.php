...
if($_GET['lookup_date']){
	if(strpos($useragent,"Firefox") == NULL){ header("Location: ./current_schedule_IE.php?lookup_date=$_GET[lookup_date]"); }
	...
	if(strpos($useragent,"Firefox") == NULL){ header("Location: ./current_schedule_IE.php"); }
	$sql_date = date("Y-n-j");
...
if($num_orders_for_user >= 1){
	...
	while($row = mysql_fetch_array($users_orders_result)){
		...
		if($row['status'] == "Cancelled" || $row['status'] == "Complete"){
			...
			$done_table = $done_table .  "<tr " . $trclass . " style=\"height:20px;\" ondblClick=\"return popup('dashboard/order_dashboard.php?order_num=$order_num', $instance_id)\"><td>" . $row['acct_name'] . "</td><td>" . $row['acct_num'] . "</td><td>" . $row['order_num'] . "</td><td>" . $row['order_type'] . "</td><td>" . $row['access_type'] . "</td><td>" . $row['market'] . "</td><td>" . $row['package'] . "</td><td>" . $newtimeslot . "</td>";
			$checkForChange = 0;
			...
			$anytime_table = $anytime_table .  "<tr " . $trclass . " style=\"height:20px;\" ondblClick=\"return popup('dashboard/order_dashboard.php?order_num=$order_num', $instance_id)\"><td>" . $row['acct_name'] . "</td><td>" . $row['acct_num'] . "</td><td>" . $row['order_num'] . "</td><td>" . $row['order_type'] . "</td><td>" . $row['access_type'] . "</td><td>" . $row['market'] . "</td><td>" . $row['package'] . "</td><td>" . $newtimeslot . "</td>";
			$anytime_table = $anytime_table .  "</tr>";
			...
			echo "<a class=\"button\" href=\"./dashboard/order_dashboard.php?order_num=$order_num\" onClick=\"return popup(this, $instance_id)\" style=\"float:right;\">Dashboard</a>";
			echo "<a class=\"button\" href=\"./bin/get_broadsoft.php?account=" . $row['acct_num'] . "\" onClick=\"return popup(this, 'BWAS" . $instance_id . "')\" style=\"float:right;margin-right:2px;\">BWAS</a><hr style=\"clear:both;\">";
...
while($row = mysql_fetch_array($schedule_result)){
	...
	if($username != "guest"){
		echo "<tr " . $trclass . " style=\"height:20px;\" ondblClick=\"return popup('dashboard/order_dashboard.php?order_num=$order_num', $instance_id)\"><td>" . $row['acct_name'] . "</td><td>" . $row['acct_num'] . "</td><td>" . $row['order_num'] . "</td><td>" . $row['order_type'] . "</td><td>" . $row['access_type'] . "</td><td>" . $row['market'] . "</td><td>" . $row['package'] . "</td><td>" . $newtimeslot . "</td>";
