...
$orderChecklistSQL = "SELECT checklist,checklist_percentage,acct_num,acct_name,activation_date,order_type FROM $v2ordertable WHERE order_num = '$order_num'";
...
echo "<br><b>2.0 PRE-CHECK CHECKLIST</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" . $question_count . " Questions (" . $checklist_percentage . "% Complete)<hr>";
