...
var answer = confirm("WARNING! - Publishing this schedule will OVERWRITE the data in the Current Schedule view.\n\nAre you sure you want to proceed?");
if(answer){
...
<body>
<h3>NOTE: Changes made here are written to a working copy of the schedule.  Changes must be published to Current Schedule before exporting.</h3>
<FORM>
<INPUT TYPE="BUTTON" VALUE="View/Change Settings" ONCLICK="window.location.href='schedule_settings.php'">
<INPUT TYPE="BUTTON" VALUE="Publish Current Schedule" ONCLICK="show_confirm()">
<INPUT TYPE="BUTTON" VALUE="Export Current Schedule to Excel" ONCLICK="window.location.href='export_schedule.php'">
<INPUT TYPE="BUTTON" VALUE="Import Orders from Current Schedule" ONCLICK="window.location.href='import_current_schedule.php'">
<INPUT TYPE="BUTTON" VALUE="Add an Order to Current Schedule" ONCLICK="window.location.href='add_order.htm'">
</FORM>
