...
<HEAD>
<TITLE>Import Source Test Result</TITLE>
</HEAD>
...
$url = "http://raptor.cbeyond.net/workspace//webRoot/Schema-415478435-601800053/95/webResources/jsp/config-list.jsp?accountNo=" . $acctnum . "&pId=" . $pid . "#";
...
if(preg_match("/div id=\"efm_switch-pre[\s\S]*<\/div><!-- #efm_switch-pre/",$file,$EFM_switch)){
	...
	$HSL = substr($EFM_switch_HSL[0],13,2);
...
if(preg_match("/div id=\"efm_cpe-pre[\s\S]*<\/div><!-- #efm_cpe-pre/",$file,$EFM_CPE)){
	...
	preg_match_all("/ENT-VLAN.*:;/",$EFM_CPE[0],$EFM_CPE_VLAN);
	
	$CPE_VLANS = $EFM_CPE_VLAN[0];
...
echo "<u><b>IAD FTP COPY STATEMENT ---->>> <font color=\"red\">SET \"RELOAD IN 5\" BEFORE DROPPING THIS</b></font></u><br>";
echo "<hr>";
echo "<br>";
...
<br>
<u><h2><font color="red"><blink>******* REMEMBER TO DO THE FOLLOWING! *******</blink></h2>
<h3><UL><LI>WRITE THE IAD CONFIG<LI>CANCEL THE IAD RELOAD ("reload cancel")<LI>CLEAN UP THE T1 INTERFACE(S) ON THE 10K</UL></font></h3></u>

<br><br><br><br>

<a href="sourcetest.html">Go Back</a>
