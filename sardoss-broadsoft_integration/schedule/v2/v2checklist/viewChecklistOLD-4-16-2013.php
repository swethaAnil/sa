...
if($order_data['order_type'] == "Change"){
	...
	$build_result = build_checklist($order_num,$connection,$source);
	
	$checklist_questions_result = $build_result[0];
	$get_percentage_SQL = $build_result[1];
	$checklist_title = $build_result[2];
	...
	$getPercentageResult = @mysql_query($get_percentage_SQL,$connection);
...
echo "<br><b>$checklist_title</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" . $question_count . " Questions (" . $checklist_percentage . "% Complete)<hr><br />";
echo $checklist_html;
