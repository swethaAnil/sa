...
if (typeof(mylink) == 'string')
	...
	href=mylink.href;
	window.open(href, windowname, 'width=800,height=600,scrollbars=yes,status=no,toolbar=no,location=no');
	return false;
}
//-->
...
while($row = mysql_fetch_array($schedule_result)){
	...
	if($row['activation_date'] != $old_date && $count != 1){
		echo "<tr class=\"border\"><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td>
	...
	if($test = $count % 2){
		echo "<tr " . $trclass . "\" style=\"height:20px;\" ondblClick=\"return popup('v2_order_dashboard.php?instance_id=$instance_id', $instance_id)\">";
	}else{
		echo "<tr " . $trclass . "_alt\" style=\"height:20px;\" ondblClick=\"return popup('v2_order_dashboard.php?instance_id=$instance_id', $instance_id)\">";
	}
	...
	echo "<td>" . $row['bandwidth'] . "</td><td>" . $row['tcps'] . "</td><td>" . $row['tcdc'] . "</td><td>" . $row['managed_services'] . "</td><td><a id=\"jiralink\" href=\"http://jira.cbeyond.net/browse/" . $row['jira_ticket'] . "\">" . $row['jira_ticket'] . "</a></td><td>" . $row['jira_ticket_status'] . "</td><td>" . $row['jira_total_mins'] . "</td><td>" . $row['siebel_order_status'] . "</td><td>" . $row['truck_roll_mins'] . "</td>";
