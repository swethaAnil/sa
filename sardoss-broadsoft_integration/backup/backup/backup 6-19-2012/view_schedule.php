...
<?php
echo "<FORM><INPUT TYPE=\"BUTTON\" VALUE=\"Export to Excel\" ONCLICK=\"window.location.href='export_schedule.php'\">";
echo "<INPUT TYPE=\"BUTTON\" VALUE=\"View/Change Settings\" ONCLICK=\"window.location.href='schedule_settings.php'\"></FORM>";
...
$schedule_output = "SELECT * FROM current_orders";
