...
<form action="tcps_database_update.php" method="post">
<br />
<b>Does this look OK? Are all the elements correct and in the proper column?</b>
<input type="Submit" value="YES, put this info in the TCPS database.">
</form>
<FORM><INPUT TYPE="BUTTON" VALUE="Cancel" ONCLICK="window.location.href='index.php'"></form>
