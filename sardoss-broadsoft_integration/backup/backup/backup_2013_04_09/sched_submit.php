...
function add_order( $acct_name, $acct_num, $access_type, $order_num, $order_type, $market, $package, $timeslot){
...
if ( $new_file ){
	...
	foreach ($rows as $row){
		...
		add_order( $acct_name, $acct_num, $access_type ,$order_num, $order_type, $market, $package, $timeslot);
		}
