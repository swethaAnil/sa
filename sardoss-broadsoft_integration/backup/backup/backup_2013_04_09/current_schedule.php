...
while($row = mysql_fetch_array($schedule_result)){
	...
	if($username != "guest"){
		echo "<td><form action=\"assignment_change.php\" method=\"post\"><input type=\"hidden\" name=\"assign_data\" value=\"$instance_id\"><input type=\"submit\" id=\"mysubmit\" value=\"...\"></form></td></tr>";
	}else{
		echo "<td></td></tr>";
	}
	$count++;
