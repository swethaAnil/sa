...
<p>
<table>
<tr><td align="right"><strong>Device:</strong></td><td><input type="radio" name="device" value="IAD">IAD&nbsp;&nbsp;<input type="radio" name="device" value="ISR">ISR</td></tr>
