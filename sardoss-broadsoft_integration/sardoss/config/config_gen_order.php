...
<option value="FIBR6">XO (Wholesale EFM)</option>
</select>
</div>
</td></tr>
</table>
...
<div id="FIBR6" <?php if($fiber_provider == "FIBR6"){ echo "style=\"display:block\""; }else{ echo "style=\"display:none\""; } ?> >
...
<tr><td class="form"><input type="text" name="CID_FIBR6" <?php if($access_type == "Fiber"){ highlight_input($circ_cid[1]); }?> /></td>
<td class="form"><input type="text" name="TENK_INTERFACE_FIBR6" <?php if($access_type == "Fiber"){ highlight_input($tenk_interface); }?> /></td>
<td class="form"><input type="text" name="VLAN_FIBR6" <?php if($access_type == "Fiber"){ highlight_input($vlan); }?> /></td>
<td class="form"><select name="rate_limit_FIBR6">
		<option value="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
		<option value="2" <?php if($committed_bw == 2){ echo "selected"; } ?> >2</option>
		<option value="4" <?php if($committed_bw == 4){ echo "selected"; } ?> >4</option>
		<option value="6" <?php if($committed_bw == 6){ echo "selected"; } ?> >6</option>
