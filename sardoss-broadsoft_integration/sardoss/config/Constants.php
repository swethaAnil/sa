...
class Constants{
	...
	public $pca_array = array(
					'PRCA1' => 'BTS',
					'PRCA2' => 'BROADSOFT',
					);
					
	public $voice_array = array(
					'VOIC1' => 'ANALOG',
					'VOIC2' => 'PRI',
					'VOIC3' => 'CAS',
					'VOIC4' => 'SIP',
	...
	public $voice_port_address = array(
					'IAD' => '2/',
					'SPIAD' => '1/0/',
					'SPIAD_ALT' => '0/2/',
					'ISR' => '2/0/'
	...
	public $fiber_interface = array(
					'IAD' => 'FastEthernet0/1',
					'SPIAD' => 'GigabitEthernet0/1',
					'ISR' => 'GigabitEthernet0/1'
					);				

	public $data_interface = array(
					'IAD' => 'FastEthernet0/0',
					'SPIAD' => 'GigabitEthernet0/0',
					'ISR' => 'GigabitEthernet0/0'
					);	

	public $sip_acl_ip_outbound = array(
	...
	public $sip_acl_ip_inbound = array(
	...
	public $dark_fiber_10K_interfaces = array(
	...
	public $dark_fiber_10K_pairs = array(
