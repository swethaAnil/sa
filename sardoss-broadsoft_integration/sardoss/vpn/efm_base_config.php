...
<head>
<title>Service Activations - ReD-CON</title>
<!--[if IE]>
...
<span class="location">
 / <a href="config_gen_order_form.php">ReD-CON</a>
 / <u>EFM Base Config</u></span>
</span>
</div>
...
<div class="optionbar">
<a style="padding-left:10px;" href="config_archive.php">Config Archive</a>
<a style="padding-left:10px;" href="config_modules.php">Config Modules</a>
<a style="padding-left:10px;" href="/sardoss/vpn/efm_base_config.php">EFM Base Config</a>
<a style="padding-left:10px;" href="/sardoss/vpn/fiber_base_config.htm">FIBER Base Config</a>
<a style="padding-left:10px;" href="/sardoss/vpn/10K_VPN_build.htm">VPN for 10K</a>
<a style="padding-left:10px;" href="http://sa.cbeyond.net/schedule">Online Schedule</a>
...
<form action="efm_base_config_output.php" onsubmit="return show_confirm()" method="POST">
