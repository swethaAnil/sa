...
<FORM>
<INPUT TYPE="BUTTON" VALUE="Publish Current Schedule" ONCLICK="window.location.href='publish_schedule.php'">
...
<INPUT TYPE="BUTTON" VALUE="Import Current Schedule to Schedule Manager" ONCLICK="window.location.href='import_current_schedule.php'">
</FORM>
...
while($row = mysql_fetch_array($schedule_result)){
	...
	if($row['order_type'] == "Change" && $tech_name != "Overflow"){
