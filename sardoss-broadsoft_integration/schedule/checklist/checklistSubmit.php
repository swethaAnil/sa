...
$orderChecklistSQL = "SELECT checklist FROM $ordertable WHERE order_num = $order_num";
...
if($orderChecklist[0] == NULL){
	$saveOrderChecklistSQL = "UPDATE $ordertable SET checklist = '$question_list' WHERE order_num = '$order_num'";
