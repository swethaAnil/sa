...
$date_output = "SELECT DISTINCT MONTH(activation_date),YEAR(activation_date) FROM current_v2_orders ORDER BY activation_date";
...
while($row = mysql_fetch_array($schedule_result)){
	...
	if($count == 1){ 
		...
		echo "<table><tr class=\"schedhead\"><th>2.0 Tech</th><th>Activation Date</th><th>Time Slot</th><th>Account Name</th><th>Acct #</th><th>Order #</th>
			...
			<th>TCPS</th><th>TCDC</th><th>Managed Services</th><th>% Checklist Complete</th><th>Siebel Order Status</th><th>Activation Truck Roll Time (mins)</th>
