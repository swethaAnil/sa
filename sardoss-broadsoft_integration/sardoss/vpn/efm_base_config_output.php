...
<head>
<title>EFM Base Config Generator</title>
</head>
...
!
!
interface FastEthernet0/0.<?php echo $vlan . "\n"; ?>
encapsulation dot1q <?php echo $vlan . "\n"; ?>
ip address <?php echo $iad_ip . " " . $subnet_mask . "\n";?>
ip nat outside
!
!
ip radius source-interface FastEthernet0/0.<?php echo $vlan . "\n"; ?>
logging source-interface FastEthernet0/0.<?php echo $vlan . "\n"; ?>
!
!
ip classless
ip route 0.0.0.0 0.0.0.0 FastEthernet0/0.<?php echo $vlan . " " . $tenk_ip . "\n"; ?>
no ip http server
!
!
line vty 0 4
